# CHIASTIC STRUCTURES IN THE TANACH

*A Comprehensive Analysis of Inverted Parallelism in the Hebrew Bible*

*With Hebrew and English Text, Visual Structural Display, and Interpretive Commentary*
...
In its basic form, a chiasm presents two or more pairs of ideas in reverse order: A-B-B'-A'. Extended chiasms add layers—A-B-C-D-C'-B'-A'—sometimes reaching nine, eleven, or more concentric tiers. These structures appear at every level of textual organization: within single verses (*micro-chiasm*), across passages of five to thirty verses (*meso-chiasm*), spanning entire chapters (*macro-chiasm*), or encompassing whole books (*grand chiasm*).[^3]

Several related terms require careful distinction. *Inclusio* (or *inclusion*) refers to the framing of a passage by repeating similar language at the beginning and end, without necessarily inverting the interior elements. While every chiasm contains an inclusio at its outer frame, not every inclusio constitutes a chiasm. *Ring composition*, a term favored by classicists and anthropologists, emphasizes the circular, self-returning quality of the structure and is often used synonymously with chiasm when discussing larger-scale patterns. *Concentric structure* highlights the funneling effect toward a central element. Throughout this study, "chiasm" and "chiastic structure" are used as the primary designations, with other terms noted where convention or precision requires them.[^4]
...
**Johann Albrecht Bengel (1742).** The German Protestant biblical scholar and textual critic was the first to introduce chiasmus as a formal technical category for inverted parallelism in Scripture. In his *Gnomon Novi Testamenti* (1742), the product of two decades of labor, Bengel argued for its hermeneutical importance: "Chiasmus is altogether worthy of being observed diligently, and is such that we hope by the knowledge of it hermeneutical studies will be still further assisted." He further emphasized that chiasmus was "never without some use, viz., in perceiving the ornament, in observing the force of the language; in understanding the true and full sense; in making clear the sound Exegesis; in demonstrating the true and neat Analysis of the sacred text."[^7]

**John Jebb (1820).** Jebb's *Sacred Literature* extended Bengel's observations to the Hebrew Bible, cataloging examples of inverted parallelism across both testaments. Jebb himself acknowledged his debt to Bengel's earlier work. Though his analyses remained largely descriptive, Jebb established chiasm as a recognized category in English-language biblical scholarship.[^8]

**Nils Wilhelm Lund (1942).** After more than a century of relative neglect, chiasm studies were transformed by Lund's *Chiasmus in the New Testament: A Study in the Form and Function of Chiastic Structures*. Lund proposed seven "laws" governing chiastic arrangement, demonstrated the pervasiveness of chiasmus throughout the New Testament, and argued that it served mnemonic, aesthetic, and theological functions simultaneously. As Roland Meynet later noted, "The great merit of Lund was to give new impetus to research on biblical rhetoric. He is also the first to attempt to establish a catalogue of proper organization of laws of the biblical texts."[^9]

**Yehuda T. Radday (1970s–1980s).** Radday pioneered the application of statistical and computational methods to chiasm detection in the Hebrew Bible, publishing studies on chiastic patterns in the Torah, Samuel, Judges, and Joshua in the journal *Linguistica Biblica*.[^10] His 1985 collaboration with Haim Shore, *Genesis: An Authorship Study in Computer-Assisted Statistical Linguistics*, represented one of the earliest attempts to bring quantitative rigor to literary-structural claims about biblical texts.[^11]
...
**Craig Blomberg (1989).** Blomberg's nine criteria for identifying genuine chiasms, published in the *Criswell Theological Review*, provided the most influential modern methodological framework, elevating discussion beyond subjective pattern-recognition.[^15]

**David A. Dorsey (1999).** Dorsey's *The Literary Structure of the Old Testament: A Commentary on Genesis–Malachi* provided the most comprehensive catalogue of chiastic structures across the entire Hebrew Bible. Systematically identifying patterns at every scale in all thirty-nine books, Dorsey demonstrated that chiasm is not merely ornamental but serves as a fundamental structural principle of biblical composition.[^16]

**Mary Douglas (1999, 2007).** The anthropologist's *Leviticus as Literature* (1999) and *Thinking in Circles: An Essay on Ring Composition* (2007) brought structuralist and anthropological perspectives to biblical chiasm. Douglas showed that Leviticus, often perceived as an incoherent legal collection, exhibits elegant concentric architecture with the Day of Atonement (Leviticus 16) at its center.[^17]
...
**Lund's Seven Laws (1942).** Lund proposed that chiasms always have an introductory element and a concluding element that parallels the introduction; always have a central element that is not repeated; have a natural beginning and end; exhibit appropriate length in their parts; arrange parts appropriately; and manifest literary quality and theological coherence.[^20]

**Welch's Degrees of Chiasticity (1981).** Welch argued that "all possible chiasms are not equal" and that "degrees of chiasticity" exist along a spectrum from clear to uncertain. He emphasized that the strength of any proposed chiasm depends on the number and quality of correspondences between matching elements, the distinctiveness of the vocabulary involved, and the theological coherence of the resulting interpretation.[^21]

**Blomberg's Nine Criteria (1989).** Blomberg's framework remains the most widely cited:

1. There must be a reasonable number of elements in an inverted pattern
2. There must be clear parallelism between the two halves
3. Verbal (grammatical) parallelism as well as conceptual (structural) parallelism should characterize most corresponding pairs
4. Verbal parallelism should involve central or dominant imagery, not peripheral language
5. Both verbal and conceptual parallelism should involve words and ideas not found regularly elsewhere in the proposed chiasm
6. Multiple sets of correspondences and multiple members are desirable
7. Corresponding sections should be proportionate in length
8. The center should be a passage worthy of climactic position in light of its theological significance
9. The structure's plausibility increases if its theme is repeated in the first and last passages[^22]

**Computational Approaches (2020s).** Recent work has introduced quantitative measures of semantic similarity between corresponding elements using vector embeddings, reducing reliance on subjective verbal-parallel judgments and capturing conceptual correspondences that traditional methods might miss. McGovern et al. (2025) developed a "chiastic score" combining lexical overlap, semantic embedding distance, and positional symmetry to rank candidate structures by probability.[^23]

**The Problem of "Chiasmania."** Mark J. Boda's influential article "Chiasmus in Ubiquity: Symmetrical Mirages in Nehemiah 9" (1996) warned against the tendency to find chiastic structures in any sufficiently long text. Boda demonstrated that applying loose criteria to Nehemiah 9 could produce multiple incompatible "chiasms" in the same passage, none of which illuminated the text's meaning. Meir Sternberg similarly cautioned that pattern-finding divorced from close reading of narrative dynamics produces hollow structural diagrams rather than genuine interpretation.[^24]

Responsible scholarship therefore distinguishes between:

- **Certain or highly probable chiasms**: multiple criteria clearly met, evident intentionality, theological coherence, broad scholarly agreement
- **Probable chiasms**: most criteria met, reasonable interpretation, accepted by many scholars
- **Possible but uncertain chiasms**: some criteria met, but alternative structural explanations exist
- **Speculative chiasms**: few criteria met, potentially forced alignments, disputed in the literature
...
**Micro-chiasm.** The smallest identifiable unit, occurring within a single verse or pair of verses. Genesis 9:6 (displayed above) is the classic example. Micro-chiasms serve primarily mnemonic and aesthetic functions.
...
**Simple chiasm.** The basic A-B-B'-A' pattern consisting of two concentric pairs.

**Extended chiasm.** Three or more concentric layers—A-B-C-C'-B'-A' or A-B-C-D-D'-C'-B'-A'—with a single central element or pair.

**Nested chiasm.** A chiasm that contains one or more subordinate chiasms within its elements. The Song of the Sea (Exodus 15), for example, contains sub-chiasms within its larger chiastic framework—a fractal-like phenomenon discussed at length in Part VII.

**Asymmetric chiasm.** Corresponding elements differ in length or elaboration. The second occurrence may be considerably shorter or longer than the first. Many genuine chiasms display some degree of asymmetry.

### By Function

**Mnemonic chiasm.** Facilitating memorization and oral transmission, particularly prevalent in poetry and wisdom literature.

**Narrative chiasm.** Structuring plot with a climactic reversal or transformation at the center. The flood narrative exemplifies this: the "descent" into judgment mirrors the "ascent" into restoration.

**Theological chiasm.** Placing the most significant theological content at the center. Leviticus positions the Day of Atonement at the book's exact midpoint, making atonement the structural and theological keystone.
...
**Egyptian literature.** The *Instructions of Ptahhotep* (c. 2350 BCE), among the oldest surviving wisdom texts, employs inverted parallelism and ring composition to frame ethical teachings. Other Egyptian instructional literature similarly uses these techniques to structure didactic material around central principles.[^27]

**Mesopotamian literature.** Sumero-Akkadian texts display chiastic patterns in royal inscriptions and votive texts. Gary Rendsburg identified a significant chiasm in the Epic of Gilgamesh that corresponds structurally with the biblical flood narrative, suggesting either literary influence or shared Near Eastern literary conventions.[^28]

**Ugaritic literature.** The Ugaritic corpus (c. 1200 BCE) shows extensive use of parallelism including chiastic patterns. The Baal Cycle and the Dan'il text employ inverted structures—for example, curses against vultures in the Dan'il text are arranged chiastically, demonstrating that Ugaritic poets, like their Hebrew counterparts, used this device for both aesthetic and emphatic purposes.[^29]

**Classical Greek literature.** Homer's epics employ elaborate ring composition at multiple scales—a technique that has been extensively studied since the work of Cedric Whitman on the *Iliad* (1958). The Greek rhetorical tradition, particularly Isocrates and the sophistic orators, formalized parallel and inverted structures as standard compositional techniques.[^30]

**Dead Sea Scrolls.** The Qumran corpus preserves chiastic structures in biblical manuscripts, sectarian documents, and pesharim, demonstrating continuity of chiastic literary practice from the biblical period through the Second Temple era.[^31]

**Rabbinic literature.** While Mishnaic and Talmudic texts employ different literary conventions than biblical prose, ring structures and parallel argument patterns appear in rabbinic discourse, suggesting ongoing Jewish engagement with structural symmetry as a compositional principle.[^32]
...
**Labels.** Elements are labeled A, B, C, D, etc., with their returning counterparts marked by a prime symbol: A', B', C'. The center is marked with **X** or the word **CENTER** in bold.

**Hebrew text.** Where provided, Hebrew appears in RTL spans: <span dir="rtl">עברית</span>. Tier 1 chiasms (the most significant and well-attested structures) include Hebrew text on every line with English translation. Tier 2 chiasms include Hebrew on the center and outer frame. Tier 3 chiasms display English only or minimal Hebrew.

**Scholarly consensus.** Each chiasm is labeled with a consensus rating—*Very Strong*, *Strong*, *Moderate*, or *Disputed*—reflecting the degree of agreement in the published literature.

**Scale designation.** Each chiasm is labeled as micro-, meso-, macro-, or grand-scale.

**Interpretive commentary.** Following each chiasm display, a paragraph discusses the structure's theological significance, its place in the broader argument of the book, and any scholarly debate surrounding it.

**Chiasms deeper than seven levels.** For particularly deep structures, inner pairs are grouped to maintain visual clarity. The full structure is described in the accompanying commentary.

### Three Tiers of Display

This study presents approximately ninety chiastic structures organized into three tiers:

**Tier 1** (~20–25 chiasms): The most significant and well-attested structures. Full Hebrew with RTL formatting and English translation on every line. Extended interpretive discussion. Multiple scholarly citations. These include the flood narrative, the Akedah, Song of the Sea, the Sinai covenant, Leviticus as a whole, Psalm 23, the Servant Songs, and others.

**Tier 2** (~40–50 chiasms): Well-established structures with strong scholarly support. Hebrew on the center and outer frame, English throughout. Brief interpretive paragraph. Key citations.

**Tier 3** (~25–30 chiasms): Structures with moderate scholarly support or those that operate at a scale where full display would be impractical. Compact English-only display with one-line interpretation.

The reader may approach this study in multiple ways: reading sequentially for a comprehensive survey; consulting individual sections for chiasms within particular biblical books; or beginning with Part VII for the synthetic and interpretive arguments that draw on the full catalogue.
...
### Genesis 1:1–2:3 — The Creation Narrative
...
### Genesis 6:10–9:19 — The Flood Narrative
...
Wenham's analysis effectively demonstrated the flood story's literary unity, challenging the source-critical fragmentation of the passage into separate J and P documents. Whatever one's view of pentateuchal sources, the final form exhibits a coherent and deliberate architecture.
...
### Genesis 11:27–25:11 — The Abraham Cycle
...
### Genesis 22:1–19 — The Akedah (Binding of Isaac)
...
The Akedah's nesting within the Abraham cycle creates a fractal effect: a chiasm within a chiasm, with the knife-point at the center of the inner ring and the covenant at the center of the outer ring. This nested architecture is discussed further in Part VII.

### Genesis 25:19–36:43 — The Jacob Cycle
...
### Genesis 49:1–28 — The Blessing of Jacob
...
### Exodus 3:1–4:5 — The Burning Bush
...
### Exodus 19–24 — The Sinai Covenant
...
### Exodus 25–40 — The Tabernacle and the Golden Calf
...
### Leviticus 1–27 — The Complete Book
...
### Numbers 22–24 — The Balaam Narrative
...
### Numbers 1–36 — The Book as a Whole
...
### Deuteronomy 1–34 — The Book as a Whole
...
### Joshua 24:1–28 — The Shechem Covenant
...
### Judges 4–5 — Deborah: Prose and Poetry
...
### 2 Samuel 15–20 — The Absalom Rebellion
...
### Isaiah 6:1–13 — The Call Narrative
...
### Isaiah 1:2–31 — The Opening Oracle
...
### Jeremiah 1:4–19 — The Call Narrative
...
**Type:** Micro-Chiasm | **Scale:** Micro | **Scholarly consensus:** Strong
...
### Jeremiah 20:7–18 — The Confession
...
### Ezekiel 1:1–3:27 — The Call Vision
...
### Ezekiel 37:1–28 — The Valley of Dry Bones
...
### Habakkuk — Dialogue and Theodicy
...
### The Twelve as a Unified Collection

**Type:** Grand Chiasm | **Scale:** Grand | **Scholarly consensus:** Moderate to Strong
...
### Psalm 8 — Human Dignity and Divine Glory
...
### Song of Songs — Love Poetry as Ring Composition
...
### Lamentations — Acrostic and Chiastic Design
...
### Ecclesiastes — Skepticism and Affirmation
...
### Ezra-Nehemiah — Restoration Narrative
...
# Part VI: THE TANACH AS CHIASTIC WHOLE
...
The A/A' correspondence is thematic rather than verbal: primeval scattering (Babel, A) is answered by purposeful settlement (Joshua, A'). The B/B' pair links patriarchal promise (land, seed, blessing) with Mosaic renewal of those promises. The C/C' pair mirrors the journey to Sinai (through the wilderness from Egypt) with the journey from Sinai (through the wilderness toward Canaan).
...
The chiasm reveals the Deuteronomistic History's theological argument: Israel's trajectory from covenant to exile is not random but structurally determined by the choice made at the center. The kingship question—human desire for institutional security versus trust in divine governance—is the hinge on which the narrative swings from promise to judgment.
...
But the surrounding books provide the response. Book IV answers the crisis by asserting that the LORD Himself reigns (Psalms 93, 95–99), independent of any human monarchy. Book V culminates in an ascending crescendo of praise (Psalms 146–150), each beginning and ending with <span dir="rtl">הַלְלוּ־יָהּ</span> ("Praise the LORD"). The chiastic structure thus creates a theological argument: the Davidic covenant's apparent failure (center) is answered not by the restoration of monarchy but by the affirmation of divine kingship and unceasing praise.

Gerald Wilson's *The Editing of the Hebrew Psalter* (1985) first proposed this editorial-theological reading of the Psalter's shape. Subsequent scholarship has refined the analysis, demonstrating that the seams between books (the doxologies at Psalms 41, 72, 89, and 106) mark structural transitions that correspond to theological movements within the chiastic framework.[^117]

---

# Part VII: SYNTHESIS AND ORIGINAL ANALYSIS
...
| Book | Tier 1 | Tier 2 | Tier 3 | Computational Candidates | Dominant Scale |
|------|--------|--------|--------|--------------------------|----------------|
| Genesis | 6 | 8 | 5 | ~230 | Grand, Macro |
| Exodus | 4 | 6 | 3 | ~150 | Grand, Macro |
| Leviticus | 2 | 3 | 2 | ~90 | Grand |
| Numbers | 1 | 3 | 3 | ~210 | Macro, Meso |
| Deuteronomy | 2 | 3 | 2 | ~120 | Grand, Macro |
| Joshua | 1 | 2 | 2 | ~60 | Grand, Meso |
| Judges | 1 | 3 | 2 | ~70 | Grand, Meso |
| Samuel | 2 | 5 | 3 | ~130 | Macro, Grand |
| Kings | 2 | 3 | 2 | ~100 | Macro |
| Isaiah | 2 | 6 | 4 | ~180 | Macro, Grand |
| Jeremiah | 1 | 4 | 2 | ~110 | Macro |
| Ezekiel | 1 | 4 | 2 | ~120 | Grand, Macro |
| The Twelve | 1 | 8 | 5 | ~190 | Macro, Meso |
| Psalms | 3 | 7 | 4 | ~200 | Meso |
| Wisdom (Prov, Job, Song) | 0 | 3 | 2 | ~80 | Grand, Meso |
| Megillot (Ruth, Lam, Eccl, Esth) | 0 | 4 | 2 | ~70 | Grand |
| Daniel | 1 | 1 | 1 | ~40 | Grand |
| Ezra-Neh, Chronicles | 0 | 2 | 1 | ~60 | Grand |

Several patterns emerge from this data:

**Torah dominance.** Genesis and Numbers contain the highest concentrations of computationally detected chiasms, consistent with their roles as the Pentateuch's major narrative books. The high count in Genesis reflects both the patriarchal cycles' elaborate chiastic architecture and the numerous micro-chiasms embedded within poetic and genealogical material.

**Prophetic richness.** Isaiah and the Twelve together account for a disproportionate share of chiasms relative to their length, suggesting that prophetic rhetoric was particularly disposed toward chiastic arrangement—perhaps because the emphasis-at-center function served the prophetic imperative to concentrate the audience's attention on a single urgent message.

**Psalms density.** The Psalter's high count reflects the prevalence of meso-chiasms within individual psalms. While few psalms exhibit grand-scale structures, the collection as a whole contributes more identified chiasms at the meso level than any other biblical book.
...
### Divine Remembrance and Initiative

| Chiasm | Center | Reference |
|--------|--------|-----------|
| Flood Narrative | "God remembered Noah" | Gen 8:1a |
| Tower of Babel | "The LORD came down to see" | Gen 11:5 |
| Burning Bush | Moses' doubt; God responds | Ex 4:1 |
| Esther | The king's sleepless night | Esth 6:1–3 |

In each case, the center marks a moment where divine initiative intersects with human crisis. God *remembers*, *descends*, *responds*, or *arranges* circumstances. The chiastic structure draws attention to this intersection as the decisive turning point.

### Covenant and Atonement

| Chiasm | Center | Reference |
|--------|--------|-----------|
| Abraham Cycle | Covenant between the pieces | Gen 15 |
| Sinai Covenant | The people's fear and awe | Ex 20:18–21 |
| Tabernacle/Golden Calf | Golden Calf → covenant restored | Ex 32–34 |
| Leviticus (whole book) | Day of Atonement | Lev 16 |
| New Covenant (Jeremiah) | "I will write my Torah on their hearts" | Jer 31:33 |

Covenant-making and covenant-restoring consistently appear at chiastic centers, revealing that biblical authors understood covenant as the gravitational center of Israel's relationship with God.

### Human Obedience and Moral Crisis

| Chiasm | Center | Reference |
|--------|--------|-----------|
| Akedah | Abraham takes the knife | Gen 22:10 |
| Jacob Cycle | Seven years' service for Rachel | Gen 29:15–30 |
| Golden Calf (inner chiasm) | "If Your presence does not go with us..." | Ex 33:15 |
| Gideon narrative | Gideon: faith declining into idolatry | Judg 6–8 |
| Solomon narrative | Temple dedication | 1 Kgs 8 |

Human action at the center often represents a moment of supreme choice—obedience or rebellion, faith or doubt. The chiastic structure dramatizes these moments by making them the point toward which all preceding narrative converges and from which all subsequent narrative flows.

### Divine Self-Revelation

| Chiasm | Center | Reference |
|--------|--------|-----------|
| Isaiah's Call | "Here am I; send me" | Isa 6:8 |
| Ezekiel's Call | The throne of sapphire | Ezek 1:22–28 |
| Fourth Servant Song | "He has borne our infirmities" | Isa 53:4–6 |
| Psalm 103 | "Merciful and gracious, slow to anger" | Ps 103:8 |
| Valley of Dry Bones | Breath enters; they live | Ezek 37:9–10 |

When God's character or presence is revealed at the center, the chiasm functions as a literary theophany: the reader, like the prophet, passes through layers of preparation to encounter the divine at the structural core.

### The Pattern of Centers
...
### The Akedah within the Abraham Cycle

The Abraham Cycle (Gen 11:27–25:11) is a grand chiasm with the covenant of the pieces (Gen 15) at its center. The Akedah (Gen 22:1–19), positioned at the A' layer of the outer chiasm, is itself a nine-element meso-chiasm with Abraham's knife-stroke at its center. This creates a two-level nested structure:

```
Outer (Abraham Cycle): A — B — C — [X: Covenant] — C' — B' — A'
                                                              ↓
Inner (Akedah):                          A — B — C — D — [X: Knife] — D' — C' — B' — A'
```

The nesting creates an interpretive relationship between the two centers: the covenant (outer X) is confirmed by the act of faith (inner X). Abraham's willingness to sacrifice Isaac demonstrates the covenant's reality; the covenant's promise gives meaning to the sacrifice. Neither center is fully intelligible without the other.[^120]

### Sub-Chiasms in the Song of the Sea

Exodus 15:1–21 is a seven-element grand chiasm. Scholars have identified that sections C and C' each contain their own internal chiastic patterns, and the D/D' pair mirrors enemy boasts against divine rhetorical questions. The overall structure thus looks like:

```
Outer: A — B — C[internal chiasm] — D — [X] — D' — C'[internal chiasm] — B' — A'
```

This means a reader encountering the Song of the Sea encounters chiastic patterning at no fewer than three levels simultaneously: the verse-level parallelism of individual lines, the internal chiasms within sections, and the grand chiasm of the whole Song. Each level reinforces the others, creating a density of structural patterning unmatched in biblical poetry.[^121]

### The Leviticus-Pentateuch Nesting

The most impressive nesting occurs in the Torah's center. The Day of Atonement (Lev 16) is a meso-chiasm; it sits at the center of Leviticus, which is a grand chiasm; Leviticus sits at the center of the Pentateuch, which is a grand chiasm. This creates a three-level nesting:

```
Level 1 (Pentateuch):    Gen — Ex — [LEV] — Num — Deut
Level 2 (Leviticus):     1-7 — 8-10 — 11-15 — [16] — 17-20 — 21-22 — 23-27
Level 3 (Day of Atonement): A — B — C — D — [X: People's sin offering] — D' — C' — B' — A'
```

The people's sin offering—the blood sprinkled on the mercy seat for the corporate atonement of Israel—is the center of the center of the center. Three levels of chiastic architecture converge on this single ritual act. The literary structure embodies the theological claim: atonement is not peripheral to the Torah's message but its innermost core, the point toward which every other text in the Pentateuch gravitates.[^122]

### Fractal Self-Similarity

In fractal geometry, the same pattern recurs at different scales of magnification. Biblical chiasm displays an analogous property: the A-B-X-B'-A' pattern appears at the level of the verse (micro), the passage (meso), the book (grand), and the corpus (Pentateuch, Hexateuch). At each scale, the center bears the greatest semantic weight, and the surrounding layers create progressive intensification toward that center.
...
In a society where sacred texts were transmitted orally before (and alongside) written fixation, structural patterns served as memory aids. Chiasm is particularly effective for memorization because it provides multiple retrieval cues: if a reciter remembers the beginning, the ending is recoverable by reversal; if the center is recalled, the surrounding elements can be reconstructed by their relationship to it. The mirror-structure creates redundancy that protects against transmission errors.[^124]

Research in cognitive psychology supports this. Studies on memory for structured versus unstructured sequences show that hierarchically organized material is significantly easier to recall. Chiastic organization provides precisely this kind of hierarchical structure, with the center serving as the anchor point and the concentric layers providing a scaffold for recall.

### Performance and Reception

Scholars of performance criticism, drawing on anthropology and folklore studies, suggest that chiasm would function with particular power in live performance contexts. A skilled performer could signal the chiastic structure through vocal emphasis, pacing, and gesture—slowing down as the center approached, marking the pivot with a change in tone, then accelerating through the return journey. Audiences familiar with the convention would recognize the structure's onset and anticipate the center, experiencing the "turn" as a moment of heightened attention.[^125]

The psalms, prophetic oracles, and wisdom sayings—the genres most densely populated with chiasms—are also the genres most closely associated with oral performance. This is not coincidental. Chiastic structure is uniquely suited to texts designed for speaking and hearing, where the audience cannot flip back to check earlier material but can track a symmetric pattern in real time.

### From Oral to Written

As Israelite culture developed increasingly sophisticated written traditions—through scribal training, Temple archives, and eventually canonization—chiasm persisted and even proliferated. Several factors explain this continuity:

1. **Scribal conservation.** Scribes copying traditional oral material preserved the chiastic patterns already present, maintaining the structural integrity of received texts.

2. **Aesthetic value.** Chiastic symmetry was recognized as a literary virtue. Even in a written culture, the elegance of a well-constructed chiasm was valued as evidence of authorial (or divine) craftsmanship.

3. **Theological function.** The center-emphasis property of chiasm made it a powerful interpretive tool. Editors arranging material into chiastic patterns could guide readers toward the theological meaning they considered most important.

4. **Scribal training.** Evidence from ancient Near Eastern scribal schools suggests that students were trained in parallel and chiastic composition as standard literary techniques. Israelite scribes, whether trained in Temple schools or broader Near Eastern academies, would have absorbed these methods as part of their professional formation.[^126]
...
### Case Study 1: The Flood Narrative

**Linear reading:** The flood narrative recounts a natural disaster caused by divine judgment. God sends the flood, destroys the wicked, preserves Noah, and makes a covenant. The narrative moves from sin to punishment to restoration.

**Chiastic reading:** The narrative converges on a single clause: "God remembered Noah" (Gen 8:1a). This is not merely the chronological midpoint but the theological center. Everything before this verse describes the world's descent into watery chaos; everything after describes the world's emergence into renewed order. The chiastic structure reveals that the narrative's subject is not the flood itself but God's remembering—a divine act of covenantal faithfulness that transforms destruction into restoration. The waters do not recede because they have run their course; they recede because God *remembers*.[^127]

### Case Study 2: Psalm 23

**Linear reading:** The psalm traces a journey from pastoral peace (vv. 1–3), through danger (v. 4), to a banquet (v. 5) and a permanent dwelling (v. 6). The movement is from nature to culture, from shepherd imagery to host imagery.

**Chiastic reading:** The valley of the shadow of death at the center is the psalm's theological climax, not its narrative trough. The chiasm reveals that divine companionship is most intensely experienced not in green pastures or at laden tables but in the midst of mortal danger. The shift from third person ("He leads me") to second person ("You are with me") at the center marks a transition from talking *about* God to talking *to* God—the moment when theology becomes prayer, when description becomes encounter. The chiastic structure makes this shift structurally visible and theologically emphatic.[^128]

### Case Study 3: The Akedah

**Linear reading:** God tests Abraham by commanding him to sacrifice Isaac. Abraham obeys. At the last moment, an angel intervenes and a ram is substituted. Abraham has passed the test.

**Chiastic reading:** The center is not the angel's intervention (which is D' in the chiasm, not the center) but Abraham's hand reaching for the knife (Gen 22:10). The chiasm reveals that the narrative's true subject is not the outcome of the test but the moment of obedience itself. The substitution of the ram (B') answers the command to take Isaac (B); the angel's call (D') answers the altar-building (D). But the center—the knife-stroke that never falls—has no corresponding element because it has no counterpart: it is the unique, unrepeatable act of absolute faith. The chiastic structure isolates this moment as the one around which the entire narrative revolves.[^129]

### Case Study 4: Leviticus

**Linear reading:** Leviticus is a legal code organized by topic: sacrifices, then purity, then holiness, then festivals. The arrangement is practical—a reference manual for priests.

**Chiastic reading:** The concentric structure reveals Leviticus as a theological argument, not a reference manual. The book asks: How can God dwell among impure people? The answer is architecturally embedded: converge on the center. The offerings (outer layer) enable approach to God; the purity laws (next layer) define what separates people from God; the Day of Atonement (center) bridges the gap. Every law in the book relates to this center, either preparing for atonement or responding to it. The chiasm transforms Leviticus from a disparate collection into a unified meditation on reconciliation.[^130]

### Case Study 5: Esther

**Linear reading:** Esther is a story of court intrigue in which a Jewish queen saves her people from genocide through courage and timing. The narrative celebrates human heroism.
...
### The "Chiasmania" Critique

Mark Boda's warning about "chiasmus in ubiquity" (1996) remains pertinent. Given sufficiently loose criteria, any extended text can be forced into a chiastic pattern. Boda demonstrated this with Nehemiah 9, producing multiple incompatible chiasms from the same passage—proof that pattern-finding without rigorous methodology produces noise rather than signal.[^132]

The risk is particularly acute with grand-scale chiasms. At the level of individual verses, chiastic word order is verifiable and often unambiguous. At the level of entire books, the "corresponding elements" become progressively more thematic and less lexical, opening the door to subjective matching. A charitable reader can find correspondences between almost any two sections of a long text.

### Criteria for Skepticism

The following indicators should trigger skepticism about a proposed chiasm:

1. **Forced correspondences.** If the analyst must use different criteria (verbal for one pair, thematic for another, structural for a third), the chiasm may be imagined rather than real.

2. **Trivial center.** If the proposed center contains no material of theological or literary significance, the structure may be an artifact of the analyst's construction rather than an authorial intention.

3. **Asymmetric truncation.** If elements must be omitted or rearranged to make the chiasm work, the original text may not be chiastic.

4. **Lack of scholarly agreement.** If multiple competent scholars have examined the same text and reached different structural conclusions, the chiastic pattern may not be sufficiently clear to establish with confidence.

5. **Circular reasoning.** If the chiasm is used to "prove" a reading that then "confirms" the chiasm, the argument is circular. Chiastic structure should be established independently before being used as an interpretive tool.

### What Chiasm Cannot Tell Us

Even genuine chiasms have limits as interpretive tools:

**Authorial intention.** We can identify structures but cannot always determine whether they were consciously designed or emerged organically through literary convention. The distinction may matter less than it seems—a skilled author trained in chiastic composition may produce chiastic structures without deliberate architectural planning, just as a trained musician produces harmonic progressions without conscious calculation.

**Chronological claims.** Chiastic structure in a text does not necessarily prove literary unity, single authorship, or a particular date of composition. A redactor can impose chiastic organization on pre-existing materials, creating a structure that postdates the individual components.

**Exclusivity.** A text may exhibit multiple valid structural analyses—chiastic, linear, concentric, and thematic—simultaneously. Chiasm need not be the only or primary structural principle at work.[^133]

### Toward a Balanced Methodology

The productive path lies between the extremes of "chiasm everywhere" and "chiasm nowhere." The criteria established by Blomberg (1989), refined by Welch and Parry (2020), and augmented by computational methods (McGovern et al. 2025) provide a framework for disciplined analysis:

- Require multiple types of correspondence (verbal, thematic, structural) for strong claims
- Insist that the center be theologically or literarily significant
- Privilege chiasms with scholarly consensus over novel proposals
...
The McGovern et al. (2025) study demonstrated that algorithmic detection of chiasms is feasible at scale. Tensor-based similarity measures and neural embeddings can identify candidate structures that human analysts might miss, while statistical tests can distinguish genuine patterns from random noise. Future work will likely:

- Extend computational detection to Aramaic, Greek, and Latin texts for comparative analysis
- Develop more sophisticated similarity metrics that capture conceptual as well as lexical correspondence
- Create open-access databases of computationally identified chiasms, ranked by probability and cross-referenced with scholarly assessments
- Apply machine learning to predict which proposed chiasms are most likely to gain scholarly acceptance[^134]

### Integration with Other Literary Methods

Chiasm studies have too often operated in isolation from other approaches to biblical literature. Integration with narrative criticism (how does chiastic structure interact with plot and characterization?), rhetorical criticism (how does chiasm function as persuasion?), and reception history (how did ancient readers perceive these structures?) will produce richer and more nuanced analyses.

The emerging field of cognitive poetics—studying how literary structures engage the mind—offers particular promise. If chiasm is fundamentally a cognitive pattern (as its cross-cultural ubiquity suggests), then research in memory, attention, and pattern recognition can illuminate both why chiasm was so prevalent in ancient literature and how it functions for modern readers.[^135]

### Canonical and Theological Implications

The grand-scale chiasms proposed in Part VI—the Hexateuch, the Deuteronomistic History, the Psalter—raise questions about canonical intentionality. If the editors who shaped the Hebrew Bible's final form organized material chiastically, then the canon's structure is itself a theological argument. The "center" of the Tanach—whether one locates it in the Sinai pericope, the Psalter, or Leviticus—becomes a claim about what matters most in Israel's faith.

This is not a new idea. The rabbis' arrangement of the Hebrew Bible into Torah, Nevi'im, and Ketuvim already implies a structural theology—Torah is foundational; the Prophets interpret; the Writings respond. Chiastic analysis adds a vertical dimension to this horizontal sequence, revealing concentric patterns that cut across the traditional divisions and suggest deeper architectures of meaning.

The history of chiasm studies—from Bengel's first observations in 1742 through Lund's revival in 1942 to the computational revolution of the 2020s—is itself a story of progressive discovery. Each generation has seen more deeply into the literary architecture of the Hebrew Bible, and each discovery has confirmed that these ancient texts reward close structural attention with theological insight. The chiasms catalogued in this study represent one chapter in that ongoing story. Future scholars, equipped with new tools and new questions, will undoubtedly see patterns that we have missed—and will challenge patterns that we have proposed. This is as it should be. The text endures; our readings of it mature.[^136]

---

# Glossary

**Asymmetric chiasm.** A chiasm in which corresponding elements differ significantly in length, emphasis, or elaboration. Many genuine chiasms display some degree of asymmetry.

**Center (pivot, turning point).** The innermost element of a chiasm, which is not repeated and bears the greatest structural and theological weight. Also called the climax, fulcrum, or X element.

**Chiasmus (pl. chiasmi, chiasms).** An inverted parallelism in which elements are arranged in an A-B-C...C'-B'-A' pattern, named after the Greek letter chi (χ). The fundamental literary device analyzed in this study.

**Chiasticity.** John W. Welch's term for the degree to which a passage exhibits chiastic properties, ranging from weak (few correspondences) to strong (multiple verbal and conceptual parallels with a significant center).

**Concentric structure.** A synonym for chiasm that emphasizes the funneling effect toward a central element. Used especially by French rhetorical critics following Roland Meynet.

**Correspondence.** A relationship of similarity (verbal, thematic, or structural) between two elements positioned symmetrically in a chiasm (e.g., between A and A').

**Decalogue.** The Ten Commandments (Exodus 20:1–17; Deuteronomy 5:6–21), which feature in the Sinai covenant chiasm.

**Deuteronomistic History.** The editorial composition spanning Deuteronomy through 2 Kings, proposed by Martin Noth (1943). Exhibits grand chiastic patterning with the transition to monarchy at its center.

**Grand chiasm.** The largest scale of chiastic structure, encompassing an entire biblical book or major division (e.g., Leviticus, the Pentateuch, the Hexateuch).

**Hexateuch.** The first six books of the Hebrew Bible (Genesis through Joshua), sometimes analyzed as a chiastic unit with the Sinai covenant at its center.

**Inclusio (inclusion).** The framing of a passage by repeating the same or similar language at the beginning and end. Every chiasm contains an inclusio at its outer layer, but not every inclusio is a chiasm.

**Inverted parallelism.** The technical term for the reversal of parallel elements that constitutes chiasmus: if A parallels B, then B' parallels A' in reverse order.
...
**Meso-chiasm.** An intermediate-scale chiasm spanning approximately five to thirty verses, the most commonly identified type in biblical scholarship.

**Micro-chiasm.** The smallest chiastic structure, occurring within a single verse or pair of verses (e.g., Gen 9:6).

**Nevi'im.** "Prophets" — the second division of the Hebrew Bible, comprising the Former Prophets (Joshua, Judges, Samuel, Kings) and the Latter Prophets (Isaiah, Jeremiah, Ezekiel, the Twelve).

**Nested chiasm.** A chiasm that contains subordinate chiasms within its elements, creating a multi-level recursive structure (e.g., the Akedah within the Abraham Cycle).

**Parallelism.** The repetition of similar or contrasting ideas in successive lines or units, the foundational feature of Hebrew poetry identified by Robert Lowth (1753). Chiasm is a structural elaboration of parallelism.

**Pericope.** A literary unit or passage, typically five to thirty verses, that constitutes a coherent section of text. The primary unit in which meso-chiasms are identified.

**Prime notation (').** The mark used to designate the returning counterpart of a chiastic element: A' ("A prime") returns to the theme of A.

**Psalter.** The Book of Psalms, divided into five books (Psalms 1–41, 42–72, 73–89, 90–106, 107–150).

**Ring composition.** A term used especially by classicists and anthropologists (Mary Douglas) for chiastic or concentric literary structure. Emphasizes the circular, self-returning quality of the pattern.

**Scapegoat (<span dir="rtl">עֲזָאזֵל</span>).** The goat sent into the wilderness on the Day of Atonement (Lev 16:8–10), bearing the sins of the people. Appears in the Day of Atonement chiasm.

**Servant Songs.** Four poems in Isaiah (42:1–4; 49:1–6; 50:4–9; 52:13–53:12) describing a figure who suffers vicariously for others. Function as structural pillars in the Deutero-Isaiah chiasm.

**Tanach (also Tanakh, TNK).** The Hebrew Bible, comprising Torah (Pentateuch), Nevi'im (Prophets), and Ketuvim (Writings).

**Theophany.** A manifestation of God, often accompanied by natural phenomena (fire, storm, earthquake). Several chiasms center on theophanic moments (e.g., Ps 29, 1 Kgs 18, Hab 3).

**Toledot (<span dir="rtl">תּוֹלְדוֹת</span>).** "Generations" — the structural formula used in Genesis ("These are the generations of...") to introduce major narrative sections. Several toledot headings mark the boundaries of chiastic structures.

**Torah.** The first five books of the Hebrew Bible (Genesis, Exodus, Leviticus, Numbers, Deuteronomy), also called the Pentateuch. The portion of the Tanach with the highest concentration of chiastic structures.

**Twelve, the.** The twelve Minor Prophets (Hosea through Malachi), compiled on a single scroll and exhibiting macro-chiastic patterning as a unified collection.

**Vicarious suffering.** Suffering undergone on behalf of others, a concept at the center of the Fourth Servant Song's chiasm (Isa 53:4–6).
...
Douglas, Mary. *Leviticus as Literature*. Oxford: Oxford University Press, 1999. Groundbreaking anthropological analysis demonstrating Leviticus's concentric structure with the Day of Atonement at its center.

Douglas, Mary. *Thinking in Circles: An Essay on Ring Composition*. New Haven: Yale University Press, 2007. Theoretical exploration of ring composition across ancient and modern literatures.

Dorsey, David A. *The Literary Structure of the Old Testament: A Commentary on Genesis–Malachi*. Grand Rapids: Baker Academic, 1999. The most comprehensive catalogue of chiastic structures across the entire Hebrew Bible.

Lund, Nils Wilhelm. *Chiasmus in the New Testament: A Study in the Form and Function of Chiastic Structures*. Chapel Hill: University of North Carolina Press, 1942. Foundational modern work; proposes seven laws of chiastic structure.

Welch, John W., ed. *Chiasmus in Antiquity: Structures, Analyses, Exegesis*. Hildesheim: Gerstenberg, 1981. Watershed comparative volume examining chiasmus across multiple ancient literatures.

Welch, John W., and Donald W. Parry, eds. *Chiasmus: The State of the Art*. Provo: BYU Studies, 2020. Survey of methodological advances over four decades.

### Biblical Scholarship

Alter, Robert. *The Art of Biblical Narrative*. New York: Basic Books, 1981. Foundational literary criticism of Hebrew narrative, including discussion of structural patterns.
...
Meynet, Roland. *Rhetorical Analysis: An Introduction to Biblical Rhetoric*. Sheffield: Sheffield Academic Press, 1998. Systematic methodology for analyzing biblical literary structures in the French rhetorical-criticism tradition.

Radday, Yehuda T. "Chiasm in Tora." *Linguistica Biblica* 19 (1972): 12–23. Early application of statistical methods to chiasm detection in the Torah.

Radday, Yehuda T., and Haim Shore. *Genesis: An Authorship Study in Computer-Assisted Statistical Linguistics*. Rome: Biblical Institute Press, 1985. Pioneering computational analysis of Genesis's literary structure.

Sternberg, Meir. *The Poetics of Biblical Narrative: Ideological Literature and the Drama of Reading*. Bloomington: Indiana University Press, 1985. Sophisticated literary criticism cautioning against over-schematized structural readings.

Walsh, Jerome T. *Style and Structure in Biblical Hebrew Narrative*. Collegeville: Liturgical Press, 2001. Systematic study of narrative techniques in the Hebrew Bible including chiastic patterns.

Warning, Wilfried. *Literary Artistry in Leviticus*. Leiden: Brill, 1999. Independent confirmation of Leviticus's concentric structure, complementing Douglas's analysis.

Watson, Wilfred G. E. *Classical Hebrew Poetry: A Guide to Its Techniques*. 2nd ed. Sheffield: Sheffield Academic Press, 1995. Standard reference work on Hebrew poetic techniques including chiasmus.

Wenham, Gordon J. "The Coherence of the Flood Narrative." *Vetus Testamentum* 28, no. 3 (1978): 336–348. Landmark demonstration of the flood narrative's thirteen-element chiasm.

Wilson, Gerald H. *The Editing of the Hebrew Psalter*. Chico: Scholars Press, 1985. Foundational study of the Psalter's editorial shaping and five-book structure.

### Prophetic Literature

Block, Daniel I. *The Book of Ezekiel*. 2 vols. New International Commentary on the Old Testament. Grand Rapids: Eerdmans, 1997–1998. Major commentary with structural analysis.

House, Paul R. *The Unity of the Twelve*. Sheffield: Almond Press, 1990. Argues for the intentional unity and structural coherence of the Minor Prophets as a single work.

Jebb, John. *Sacred Literature*. London: Cadell and Davies, 1820. Early English-language catalogue of chiastic patterns in the Bible.

Lundbom, Jack R. *Jeremiah 1–20*; *Jeremiah 21–36*; *Jeremiah 37–52*. Anchor Bible. New York: Doubleday, 1999–2004. Major commentary with attention to chiastic structures.

Nogalski, James D. *Redactional Processes in the Book of the Twelve*. Berlin: De Gruyter, 1993. Foundational study of editorial arrangement in the Minor Prophets.

Sweeney, Marvin A. *Isaiah 1–39*. Forms of the Old Testament Literature XVI. Grand Rapids: Eerdmans, 1996. Form-critical analysis with structural attention.

Sweeney, Marvin A. *The Twelve Prophets*. 2 vols. Berit Olam Commentary. Collegeville: Liturgical Press, 2000. Commentary treating the Twelve as a unified literary collection.

### Computational and Recent Scholarship

McGovern, Garrett, et al. "Computational Discovery of Chiasmus in the Hebrew Bible." In *Proceedings of the North American Chapter of the Association for Computational Linguistics (NAACL)*. Association for Computational Linguistics, 2025. First mathematical formalism and computational algorithm for biblical chiasmus detection.

Schart, Aaron, and James Nogalski, eds. *Perspectives on the Formation of the Book of the Twelve*. Berlin: De Gruyter, 2016. Recent edited volume on the Twelve's editorial formation.

### Ancient Near Eastern Context

Rendsburg, Gary A. "The Biblical Flood Story in the Light of the Gilgamesh Flood Account." In *Gilgamesh and the World of Assyria*, edited by Joseph Azize and Noel Weeks, 115–127. Leuven: Peeters, 2007. Structural comparison of the biblical and Mesopotamian flood narratives.

Whitman, Cedric H. *Homer and the Heroic Tradition*. Cambridge: Harvard University Press, 1958. Foundational analysis of ring composition in the *Iliad*.
...
[^1]: The term was introduced by Johann Albrecht Bengel in his *Gnomon Novi Testamenti* (1742). See Welch, *Chiasmus in Antiquity*, 9–16, for the terminological history.

[^2]: This micro-chiasm is widely cited as the paradigmatic example. See Watson, *Classical Hebrew Poetry*, 202–203; Dorsey, *Literary Structure*, 52.

[^3]: Dorsey, *Literary Structure*, 15–22, provides a comprehensive scale taxonomy. The terminology varies among scholars; this study follows Dorsey's four-level classification.

[^4]: On inclusio vs. chiasm, see Watson, *Classical Hebrew Poetry*, 282–284. On ring composition, see Douglas, *Thinking in Circles*, 1–36. On concentric structure, see Meynet, *Rhetorical Analysis*, 185–210.

[^5]: Lowth, *De Sacra Poesi Hebraeorum*, Lectures XVIII–XIX. The priority of medieval Jewish scholars in recognizing parallelism is noted by James Kugel, *The Idea of Biblical Poetry* (New Haven: Yale University Press, 1981), 96–97.

[^6]: Watson, *Classical Hebrew Poetry*, 201.

[^7]: Bengel, *Gnomon Novi Testamenti*, Preface, §29. Translated in Welch, *Chiasmus in Antiquity*, 10.

[^8]: Jebb, *Sacred Literature* (London, 1820). On Jebb's relationship to Bengel, see Welch, *Chiasmus in Antiquity*, 11–12.

[^9]: Lund, *Chiasmus in the New Testament* (1942). Meynet's assessment appears in *Rhetorical Analysis*, 134.

[^10]: Radday, "Chiasm in Tora," *Linguistica Biblica* 19 (1972): 12–23; "Chiasm in Samuel," *Linguistica Biblica* 9/10 (1971); "Chiasm in Joshua, Judges and Others," *Linguistica Biblica* 27/28 (1973).

[^11]: Radday and Shore, *Genesis: An Authorship Study* (Rome: Biblical Institute Press, 1985).

[^12]: Fishbane, "Composition and Structure in the Jacob Cycle," *JJS* 26 (1975): 15–38.

[^13]: Wenham, "The Coherence of the Flood Narrative," *VT* 28, no. 3 (1978): 336–348.

[^14]: Welch, ed., *Chiasmus in Antiquity* (Hildesheim: Gerstenberg, 1981).

[^15]: Blomberg, "The Structure of 2 Corinthians 1–7," *CTR* 4, no. 1 (1989): 3–20.

[^16]: Dorsey, *The Literary Structure of the Old Testament* (Grand Rapids: Baker Academic, 1999).

[^17]: Douglas, *Leviticus as Literature* (Oxford: OUP, 1999); *Thinking in Circles* (New Haven: Yale UP, 2007).

[^18]: Welch and Parry, eds., *Chiasmus: The State of the Art* (Provo: BYU Studies, 2020).

[^19]: McGovern et al., "Computational Discovery of Chiasmus in the Hebrew Bible," *NAACL Proceedings* (2025).

[^20]: Lund, *Chiasmus in the New Testament*, 40–41.

[^21]: Welch, *Chiasmus in Antiquity*, 14–15.

[^22]: Blomberg, "Structure of 2 Corinthians 1–7," 4–8. The nine criteria are paraphrased here; for the full formulation, consult the original article.

[^23]: McGovern et al., "Computational Discovery of Chiasmus," §3.2–3.4.

[^24]: Boda, "Chiasmus in Ubiquity," *JSOT* 71 (1996): 55–70. Sternberg, *Poetics of Biblical Narrative* (Bloomington: Indiana UP, 1985), esp. chapters 2–3.

[^25]: Dorsey, *Literary Structure*, 15–22; Welch, *Chiasmus in Antiquity*, 9–16; Douglas, *Thinking in Circles*, 1–36.

[^26]: For a comprehensive survey, see the chapters on Sumero-Akkadian, Ugaritic, Greek, and Latin literature in Welch, *Chiasmus in Antiquity*.

[^27]: On Egyptian instructional literature, see Miriam Lichtheim, *Ancient Egyptian Literature*, 3 vols. (Berkeley: University of California Press, 1973–1980), vol. 1.

[^28]: Rendsburg, "The Biblical Flood Story in the Light of the Gilgamesh Flood Account," in Azize and Weeks, *Gilgamesh and the World of Assyria* (Leuven: Peeters, 2007), 115–127.

[^29]: On Ugaritic parallelism, see Dennis Pardee, "Ugaritic," in Welch, *Chiasmus in Antiquity*, 69–86.

[^30]: Whitman, *Homer and the Heroic Tradition* (Cambridge: Harvard UP, 1958). On Greek rhetorical use of ring composition, see Douglas, *Thinking in Circles*, 37–60.

[^31]: On chiastic structures in Qumran texts, see Carol Newsom, *The Self as Symbolic Space* (Leiden: Brill, 2004), 195–220.

[^32]: On structural patterns in rabbinic literature, see the chapter on Talmudic-Aggadic narrative in Welch, *Chiasmus in Antiquity*, 183–197.

[^33]: McGovern et al., "Computational Discovery of Chiasmus," Table 2. The computational analysis detected 230+ candidate chiasms in Genesis and 210+ in Numbers at the verse and half-verse levels.

[^34]: This grand-level analysis is proposed by Dorsey, *Literary Structure*, 46–48, and discussed by Douglas, *Leviticus as Literature*, 214–218. See also Kline, "Structure Is Theology," 351–355, for the placement of Leviticus at the center.

[^35]: Kline, "Structure Is Theology," 362–365.

[^36]: On the numerical symmetries of Genesis 1, see Umberto Cassuto, *A Commentary on the Book of Genesis* (Jerusalem: Magnes Press, 1961), vol. 1, 12–15. The word-count observations are widely cited; see also Dorsey, *Literary Structure*, 49.

[^37]: Dorsey, *Literary Structure*, 49–50.

[^38]: Wenham, "The Coherence of the Flood Narrative," 336–348.

[^39]: Wenham, "Coherence," 341–343. On *zakar* (remember) as covenantal action, see Brevard Childs, *Memory and Tradition in Israel* (London: SCM Press, 1962), 31–44.

[^40]: On the Tower of Babel chiasm, see Dorsey, *Literary Structure*, 53; also Isaac Kikawada and Arthur Quinn, *Before Abraham Was* (Nashville: Abingdon, 1985), 82–89.

[^41]: On the double <span dir="rtl">לֶךְ־לְךָ</span>, see Gary Rendsburg, *The Redaction of Genesis* (Winona Lake: Eisenbrauns, 1986), 27–33. The Abraham cycle's chiastic structure is discussed by Dorsey, *Literary Structure*, 54–58.

[^42]: On the Akedah's chiastic structure, see Dorsey, *Literary Structure*, 57; also R. W. L. Moberly, *The Theology of the Book of Genesis* (Cambridge: CUP, 2009), 175–202.

[^43]: Fishbane, "Composition and Structure in the Jacob Cycle," *JJS* 26 (1975): 15–38.

[^44]: On the Joseph narrative's chiastic structure, see Dorsey, *Literary Structure*, 60–62. On the Judah-Tamar episode (Gen 38) as integral to the chiasm, see Judah Goldin, "The Youngest Son or Where Does Genesis 38 Belong?" *JBL* 96, no. 1 (1977): 27–44.

[^45]: Dorsey, *Literary Structure*, 63. The centrality of Gen 49:18 is noted by Nahum Sarna, *Genesis* (JPS Torah Commentary; Philadelphia: JPS, 1989), 338.

[^46]: Dorsey, *Literary Structure*, 67–68.

[^47]: On the Song of the Sea's chiastic structure and internal sub-chiasms, see Frank Moore Cross and David Noel Freedman, *Studies in Ancient Yahwistic Poetry* (Grand Rapids: Eerdmans, 1975), 45–65.

[^48]: On the Sinai covenant chiasm, see Dorsey, *Literary Structure*, 72–74.

[^49]: On the tabernacle-Golden Calf chiasm, see Dorsey, *Literary Structure*, 74–78.

[^50]: On the inner chiasm of the Golden Calf episode and Ex 33:15 as its center, see R. W. L. Moberly, *At the Mountain of God* (Sheffield: JSOT Press, 1983), 45–81.

[^51]: Douglas, *Leviticus as Literature* (1999); Warning, *Literary Artistry in Leviticus* (1999). The independent convergence of these two scholars on the same concentric structure significantly strengthens the proposal.

[^52]: Dorsey, *Literary Structure*, 81–84; Douglas, *Leviticus as Literature*, 218–241; Kline, "Structure Is Theology," 358–372.

[^53]: Kline, "Structure Is Theology," 351.

[^54]: On the Day of Atonement's internal chiasm, see Douglas, *Leviticus as Literature*, 234–238; Warning, *Literary Artistry in Leviticus*, 142–156.

[^55]: McGovern et al., "Computational Discovery of Chiasmus," Table 2.

[^56]: On the Balaam narrative's chiastic structure, see Dorsey, *Literary Structure*, 94–96.

[^57]: On Numbers' grand structure, see Dennis Olson, *The Death of the Old and the Birth of the New* (Chico: Scholars Press, 1985), 83–125; Dorsey, *Literary Structure*, 88–92.

[^58]: Kaufman, "The Structure of the Deuteronomic Law," *Maarav* 1, no. 2 (1978–79): 105–158. On Deuteronomy's grand chiasm, see Dorsey, *Literary Structure*, 96–102.

[^59]: On the Song of Moses (Deut 32), see Dorsey, *Literary Structure*, 100–101.

[^60]: Dorsey, *Literary Structure*, 103–106, introduces the Former Prophets section. Walsh, *Style and Structure*, provides detailed structural analyses of narrative passages.

[^61]: Clarke, *Joshua's Spiritual Warfare*, 23–31. Dorsey, *Literary Structure*, 107–108.

[^62]: Dorsey, *Literary Structure*, 111–112.

[^63]: Dorsey, *Literary Structure*, 106–112.

[^64]: Tanner, "The Gideon Narrative as the Focal Point of Judges," *BSac* 149 (1992): 146–161. Dorsey, *Literary Structure*, 113–120. Webb, *Book of the Judges*, 159–177.

[^65]: On the Song of Deborah's chiastic structure, see Dorsey, *Literary Structure*, 116–117.

[^66]: Dorsey, *Literary Structure*, 122–124.
...
[^70]: Dorsey, *Literary Structure*, 133–138.

[^71]: Dorsey, *Literary Structure*, 139–140.

[^72]: On the Elijah-Elisha succession, see Dorsey, *Literary Structure*, 143–144.

[^73]: Dorsey, *Literary Structure*, 147, introduces the Latter Prophets section.

[^74]: Dorsey, *Literary Structure*, 147–162; Sweeney, *Isaiah 1–39*, 39–62.

[^75]: On Isaiah 6 as chiastic structure, see Dorsey, *Literary Structure*, 153–154.
...
[^79]: On Jeremiah's overall structure with the Book of Comfort at center, see Lundbom, *Jeremiah 1–20*, 66–82.

[^80]: On Jeremiah's call narrative chiasm, see Lundbom, *Jeremiah 1–20*, 227–239; Dorsey, *Literary Structure*, 165.

[^81]: On the New Covenant passage at the center of the Book of Comfort, see Lundbom, *Jeremiah 21–36*, 458–474.

[^82]: On Jeremiah 20's confessional chiasm, see Lundbom, *Jeremiah 1–20*, 845–862.

[^83]: On Ezekiel's overall chiastic structure, see Block, *Book of Ezekiel*, vol. 1, 24–38; Dorsey, *Literary Structure*, 173–178.

[^84]: On Ezekiel's call vision chiasm, see Block, *Book of Ezekiel*, vol. 1, 82–138; Dorsey, *Literary Structure*, 174–175.

[^85]: On the Valley of Dry Bones chiasm, see Dorsey, *Literary Structure*, 177.

[^86]: On Ezekiel's temple vision chiasm, see Block, *Book of Ezekiel*, vol. 2, 494–584; Dorsey, *Literary Structure*, 177–178.

[^87]: Nogalski, *Redactional Processes* (1993); House, *Unity of the Twelve* (1990); Schart, in Schart and Nogalski, *Perspectives on the Formation* (2016).

[^88]: On Jonah's chiastic structure, see Dorsey, *Literary Structure*, 187–188. This is one of the most widely recognized chiasms in the Hebrew Bible.

[^89]: On the geographical chiasm of Amos's oracles, see Dorsey, *Literary Structure*, 184–185.

[^90]: On Micah's chiastic structure, see Dorsey, *Literary Structure*, 189–191; Sweeney, *Twelve Prophets*, vol. 2, 339–344.

[^91]: On Habakkuk's chiasm, see Dorsey, *Literary Structure*, 193–194.

[^92]: On Malachi's disputation structure, see Dorsey, *Literary Structure*, 199–200.

[^93]: On the Twelve as a unified chiastic collection, see House, *Unity of the Twelve*, 71–96; Nogalski, *Redactional Processes*, 243–275.

[^94]: Dorsey, *Literary Structure*, 201, introduces the Writings section.

[^95]: On Psalm 1's chiastic structure, see Dorsey, *Literary Structure*, 203.

[^96]: On Psalm 8's chiasm and inclusio, see Dorsey, *Literary Structure*, 205.

[^97]: On Psalm 23's chiastic structure with the valley of death at center, see Dorsey, *Literary Structure*, 206–207.

[^98]: On Psalm 29's sevenfold "voice of the LORD," see Dorsey, *Literary Structure*, 208.

[^99]: On Psalm 51's chiasm, see Dorsey, *Literary Structure*, 210.

[^100]: On Psalm 103 and the intertext with Exodus 34:6, see Dorsey, *Literary Structure*, 212.

[^101]: On the Songs of Ascents as a concentric collection, see Dorsey, *Literary Structure*, 213–215.

[^102]: On Proverbs 1–9's chiastic structure, see Dorsey, *Literary Structure*, 218–220.

[^103]: On Job's grand chiasm with chapter 28 at center, see Dorsey, *Literary Structure*, 224–228.

[^104]: On Song of Songs' ring composition, see Dorsey, *Literary Structure*, 222–223.

[^105]: On Ruth's chiastic structure, see Dorsey, *Literary Structure*, 231–233.

[^106]: On Lamentations' concentric structure with chapter 3 as triple-acrostic center, see Dorsey, *Literary Structure*, 234–236.

[^107]: On Ecclesiastes' chiastic structure, see Dorsey, *Literary Structure*, 237–239.

[^108]: On Esther's chiastic structure, see Dorsey, *Literary Structure*, 240–243.

[^109]: On the Aramaic section of Daniel (2–7) as chiasm, see Dorsey, *Literary Structure*, 244–247. This chiasm is widely accepted; see also John Goldingay, *Daniel* (Word Biblical Commentary; Dallas: Word, 1989), xxxiii–xxxiv.

[^110]: On Ezra-Nehemiah's chiastic structure, see Dorsey, *Literary Structure*, 248–250.

[^111]: On Chronicles' grand structure, see Dorsey, *Literary Structure*, 251–255.

[^112]: On corpus-level chiastic proposals, see Dorsey, *Literary Structure*, 45–48.

[^113]: On the Hexateuch chiasm, see Dorsey, *Literary Structure*, 46–47.

[^114]: On the canonical implications of the Hexateuch vs. Deuteronomistic History debate, see David Noel Freedman, "The Formation of the Canon of the Old Testament," in *Religion and Law*, ed. E. B. Firmage et al. (Winona Lake: Eisenbrauns, 1990), 315–331.

[^115]: On the Deuteronomistic History's grand chiastic structure, see Dorsey, *Literary Structure*, 103–106.

[^116]: Wilson, *Editing of the Hebrew Psalter*, 199–228.

[^117]: Wilson, *Editing*, 199–228. On the theological significance of the Psalter's five-book division, see also J. Clinton McCann Jr., "The Book of Psalms," in *The New Interpreter's Bible* (Nashville: Abingdon, 1996), vol. 4, 641–677.

[^118]: Tier counts are tabulated from the chiasms analyzed in Parts II–V of this study. Computational candidate counts are approximations based on McGovern et al. (2025), Table 2.

[^119]: This synthesis draws on the centerpiece analyses throughout Parts II–V and extends Douglas's observation in *Thinking in Circles*, 133–145, that the center of a ring composition reveals the author's deepest concern.

[^120]: On the Akedah's nesting within the Abraham Cycle, see Dorsey, *Literary Structure*, 54–58.

[^121]: On the Song of the Sea's nested sub-chiasms, see Cross and Freedman, *Studies in Ancient Yahwistic Poetry*, 45–65.

[^122]: The three-level nesting is discussed by Kline, "Structure Is Theology," 362–365.

[^123]: The fractal analogy is original to this study, though it builds on Douglas's observations in *Thinking in Circles*, 133–145, about the self-similar quality of ring composition.

[^124]: On mnemonic function, see Susan Niditch, *Oral World and Written Word* (Louisville: Westminster John Knox, 1996), 78–107.

[^125]: On performance criticism and chiasm, see David Rhoads, "Performance Criticism: An Emerging Methodology in Second Testament Studies," *BTB* 36, no. 3 (2006): 118–133.

[^126]: On scribal training in chiastic composition, see Karel van der Toorn, *Scribal Culture and the Making of the Hebrew Bible* (Cambridge: Harvard UP, 2007), 51–74.

[^127]: This case study extends Wenham's analysis in "Coherence of the Flood Narrative," 341–343.

[^128]: This reading of Psalm 23 draws on Dorsey, *Literary Structure*, 206–207, and develops the second-person shift observation.

[^129]: This reading of the Akedah draws on Dorsey, *Literary Structure*, 57, and the observation that the center has no returning counterpart.

[^130]: This reading of Leviticus draws on Douglas, *Leviticus as Literature*, 218–241, and Kline, "Structure Is Theology," 351–378.

[^131]: This reading of Esther draws on Dorsey, *Literary Structure*, 240–243, and develops the observation about the center's thematic significance in a book that never mentions God.

[^132]: Boda, "Chiasmus in Ubiquity," *JSOT* 71 (1996): 55–70.

[^133]: These methodological observations draw on Boda, Sternberg, and the refined criteria in Welch and Parry, *Chiasmus: The State of the Art* (2020).

[^134]: On the future of computational chiasm detection, see McGovern et al., "Computational Discovery of Chiasmus," §5 (Future Work).

[^135]: On cognitive poetics and literary structure, see Reuven Tsur, *Toward a Theory of Cognitive Poetics* (Brighton: Sussex Academic Press, 2008), 335–370.

[^136]: This concluding reflection draws on the historiographical overview in Welch, *Chiasmus in Antiquity*, 9–16, and extends it to the computational era.
